...
import (
	"context"
	twov2 "example/apis/two/v2"
	versioned "example/generated/two/v2/clientset/versioned"
	internalinterfaces "example/generated/two/v2/informers/externalversions/internalinterfaces"
	v2 "example/generated/two/v2/listers/two/v2"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TwoV2().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TwoV2().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&twov2.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&twov2.Foo{}, f.defaultInformer)
}
