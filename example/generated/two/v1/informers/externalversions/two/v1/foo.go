...
import (
	...
	versioned "example/generated/two/v1/clientset/versioned"
	internalinterfaces "example/generated/two/v1/informers/externalversions/internalinterfaces"
	v1 "example/generated/two/v1/listers/two/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TwoV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TwoV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&twov1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&twov1.Foo{}, f.defaultInformer)
}
