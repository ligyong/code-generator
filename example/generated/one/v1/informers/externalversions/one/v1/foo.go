...
import (
	...
	versioned "example/generated/one/v1/clientset/versioned"
	internalinterfaces "example/generated/one/v1/informers/externalversions/internalinterfaces"
	v1 "example/generated/one/v1/listers/one/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OneV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OneV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&onev1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&onev1.Foo{}, f.defaultInformer)
}
